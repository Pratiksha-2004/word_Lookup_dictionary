"""
URL configuration for dictionary_backend project.
...
urlpatterns = [
    ...
    path('api/lookup/', views.search_word, name='search_word_lookup'),
    path('api/history/', views.search_history, name='search_history'),
    path('dictionary/search/', views.search_word, name='search_word_dict'),
